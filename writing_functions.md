...
``` r
z_score(c("my", "name", "is", "camille"))
```

    ## Error in z_score(c("my", "name", "is", "camille")): Argument should be numbers
...
Having one function to prevent this is so much better. Let’s try and
